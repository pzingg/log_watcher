defmodule ExampleWeb.ConnCase do
  ...
  by setting `use ExampleWeb.ConnCase, async: false`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = LogWatcher.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = LogWatcher.Accounts.generate_user_session_token(user)
